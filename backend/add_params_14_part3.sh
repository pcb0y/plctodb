...
echo "=== 添加25A故障信号 ==="
add_param "25A调速故障" "" "V4550.1" "Bool" ""
add_param "25A过电流" "" "V4550.7" "Bool" ""
add_param "25A料筒冷却风机故障" "" "V4550.4" "Bool" ""

echo ""
echo "=== 添加25B故障信号 ==="
add_param "25B调速故障" "" "V4551.4" "Bool" ""
add_param "25B过电流" "" "V4551.7" "Bool" ""
...
echo ""
echo "=== 添加25A转速电流参数 ==="
add_param "25A转速" "SV" "VD208" "Real" "RPM"
