...
add_param "B组35机3区" "SV" "VW160" "Int" "°C"
add_param "B组35机3区" "PV" "VW360" "Int" "°C"

echo ""
echo "=== 添加A组备用参数 ==="
add_param "A组备用1" "SV" "VW1360" "Int" "°C"
add_param "A组备用1" "PV" "VW360" "Int" "°C"
add_param "A组备用2" "SV" "VW1166" "Int" "°C"
add_param "A组备用2" "PV" "VW366" "Int" "°C"

echo ""
echo "=== 添加B组备用参数 ==="
add_param "B组备用1" "SV" "VW1156" "Int" "°C"
add_param "B组备用1" "PV" "VW356" "Int" "°C"
add_param "B组备用2" "SV" "VW1158" "Int" "°C"
add_param "B组备用2" "PV" "VW358" "Int" "°C"
